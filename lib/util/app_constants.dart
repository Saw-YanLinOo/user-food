...
class AppConstants {
  static const String appName = 'MoMoFood';
  static const double appVersion = 7.0;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;

  //static const String baseUrl = 'https://momo.softedify.online';
  static const String baseUrl = 'https://momo.softedify.vip';
  //https://momo.softedify.vip
  // static const String baseUrl = 'https://testing.momofooddelivery.com';
  //static const String baseUrl = 'https://freshbitesxpress.com';
  static const String categoryUri = '/api/v1/categories';
  static const String bannerUri = '/api/v1/banners';
  static const String storeImageUri = '/api/v1/customer/order/kpay-image';
  static const String popUpBannerUri = '/api/v1/banners/popup';
  ...
  static const String featuredProductUri = '/api/v1/products/feature';
  ...
  static const String additionalNote = '/api/v1/config/addition';
  ...
  static const String guestsendCheckoutNotificationUri =
      '/api/v1/customer/order/guest-send-notification';
  ...
  static const String discountProductUri = '/api/v1/products/discount';
  static const String guestId = 'momofood_guest_id';
  static const String guestNumber = 'momofood_guest_number';
...
//guest login
  ...
  /// Deep Links
  static const String yourScheme = 'MoMoFood';
  static const String yourHost = 'MoMoFooddelivery.com';
