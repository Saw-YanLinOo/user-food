...
import 'package:user/data/model/response/wallet_model.dart';
...
class WalletController extends GetxController implements GetxService{
  ...
  RxBool isWave=false.obs;
  RxBool isKPay=false.obs;
  XFile? _pickedIDFrontFile;
  RxString imageFrontPath ="".obs;
  List<Transaction>? get transactionList => _transactionList;
  XFile? get pickedIDFrontFile => _pickedIDFrontFile;
  final TextEditingController amountController = TextEditingController();
  final TextEditingController amountTransferController = TextEditingController();
  final TextEditingController receivePhoneController = TextEditingController();
  final TextEditingController accountController = TextEditingController();
  final TextEditingController transController = TextEditingController();
  RxBool isTextEmpty =true.obs;
  RxBool isAmountTextEmpty =true.obs;
  RxBool isPhoneTextEmpty =true.obs;
