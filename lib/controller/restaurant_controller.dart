...
import 'package:user/data/model/response/cart_suggested_item_model.dart';
import 'package:user/data/model/response/category_model.dart';
import 'package:user/data/model/response/product_model.dart';
import 'package:user/data/model/response/recommended_product_model.dart';
...
class RestaurantController extends GetxController implements GetxService {
  ...
  final RxnString tableId = RxnString();
  ...
  int _veg = 0;
  int _nonVeg = 0;
  int _homeRestaurant = 0;
  int _bigRestaurant = 0;
  int _streetShop = 0;
  int _onlineOnlyShop = 0;
  ...
  int get homeRestaurnt => _homeRestaurant;
  int get bigRestaurant => _bigRestaurant;
  int get streetShop => _streetShop;
  int get onlineOnlyShop => _onlineOnlyShop;
  ...
  void setHomeRestaurant() {
    if (_homeRestaurant == 0) {
      _homeRestaurant = 1;
      _bigRestaurant = 0;
      _streetShop = 0;
      _onlineOnlyShop = 0;
  ...
  void setOnlineOnlyShop() {
    if (_onlineOnlyShop == 0) {
      _onlineOnlyShop = 1;
      _veg = 0;
      _nonVeg = 0;
