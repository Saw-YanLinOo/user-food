...
class RatingBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Icon(Icons.star, color: Theme.of(context).secondaryHeaderColor, size: size*1.4),
        Dimensions.kSizedBoxW5,
        Text(
          '$ratingCount', textDirection: TextDirection.ltr,
          style: robotoBold.copyWith(fontSize: size*1.3, color: Theme.of(context).disabledColor),
        ),
      ],
    );
  }
