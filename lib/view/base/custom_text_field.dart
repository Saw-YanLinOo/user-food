...
import 'package:user/view/base/code_picker_widget.dart';
...
class CustomTextField extends StatefulWidget {
  ...
  const CustomTextField({
    ...
    this.isValidate,
    this.requireText,
    this.suffixIcon, this.showSuffix,
  });
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: robotoRegular.copyWith(
              fontSize: Dimensions.fontSizeLarge,
              color: Get.isDarkMode ? Colors.white.withOpacity(0.6) : Colors.white,
            ),
            filled: true,
            ...
            suffixIcon:
                widget.isPassword
                    ...
                    :(widget.showSuffix??false)? widget.suffixIcon : null,
          ),
          validator: (value) {
            if (widget.isValidate == true) {
              if (value!.isEmpty) {
                return widget.requireText ?? "This field is required.";
              }
            }
            return null;
          },
