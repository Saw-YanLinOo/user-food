...
class RestaurantFooterView extends StatefulWidget {
  final Widget child;
  final double minHeight;
  final bool visibility;
  const RestaurantFooterView(
      {super.key,
      required this.child,
      this.minHeight = 0.65,
  ...
  @override
  State<RestaurantFooterView> createState() => _RestaurantFooterViewState();
}

class _RestaurantFooterViewState extends State<RestaurantFooterView> {
