...
class NoDataScreen extends StatelessWidget {
  ...
  final bool fromNoti;
  const NoDataScreen({super.key, required this.text, this.isCart = false, this.fromAddress = false,  this.fromNoti=false});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(mainAxisAlignment:  fromAddress ? MainAxisAlignment.start : MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
        ...
        Center(
          child: Image.asset(
            fromAddress ? Images.address : isCart ? Images.emptyCart :fromNoti? Images.noti: Images.emptyBox,
