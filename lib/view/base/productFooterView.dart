...
import 'package:user/view/base/handover/text_hover.dart';
import 'package:user/view/screens/auth/widget/auth_dialog.dart';

import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:url_launcher/url_launcher_string.dart';

class ProductFooterView extends StatefulWidget {
  final Widget child;
  final double minHeight;
  final bool visibility;
  const ProductFooterView(
      {super.key,
      required this.child,
      this.minHeight = 0.65,
  ...
  @override
  State<ProductFooterView> createState() => _ProductFooterViewState();
}

class _ProductFooterViewState extends State<ProductFooterView> {
