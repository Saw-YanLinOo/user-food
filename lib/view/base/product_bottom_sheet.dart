  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<ProductController>(builder: (productController) {
        bool isAvailable = widget.inRestaurantPage?
        widget.product!.restaurantOpen == 1 &&
            widget.product!.restaurantActive == 1 &&
            widget.product!.foodOpen == 1: 
            widget.product!.restaurantActive == 1 &&
            widget.product!.foodOpen == 1;
                            ...
                            Padding(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: widget
                                                                      ...
                                                                      ? Get.find<
                                                                          ...
                                                                          .campaignImageUrl
                                                                          .toString()
                                                                      : 'https://momo.softedify.vip/storage/app/public/Addon/${widget.product!.addOns![index].image}',
                                                                  width: ResponsiveHelper
                                                                          .isMobile(
                                                                              context)
                                                                      ? 50
                                    ...
                                    InkWell(
                                      onTap:(){
                                        Get.snackbar('Coming Soon', "Under Maintenance");
                                      },
                                      child: Row(
                                        children: [
                                          Icon(Icons.add,color: Theme.of(context).indicatorColor,),
                                          CustomText(text: 'enter_instruction'.tr,color: Theme.of(context).indicatorColor,)
                                        ],
                                      ),
                                    )
                                  ]),
