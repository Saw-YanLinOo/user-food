...
import 'package:user/view/screens/wallet/wallet_transfer_confirm.dart';
                          ...
                          return Column(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  CustomText(text: "receive_phone".tr,color: Theme.of(context).disabledColor,),
                                  Dimensions.kSizedBoxH10,

                                  CustomTextFormField(
                                      keyBoardType: TextInputType.number,
                                      onChange: (a){
                                        walletController.receivePhoneController.text=a;
                                        if(a.isNotEmpty){
                                          walletController.isPhoneTextEmpty.value=false;
                                        }
                                        else{
                                          walletController.isPhoneTextEmpty.value=true;
                                        }

                                      },
                                      textColor: Theme.of(context).disabledColor,
                                      controller: walletController.receivePhoneController,
                                      fillColor: Colors.transparent,
                                      radius: Dimensions.radiusDefault,
                                      hintText: '', isValidate: false),

                                  Dimensions.kSizedBoxH15,
                                  CustomText(text: "transfer_amount".tr,color: Theme.of(context).disabledColor,),
                                  Dimensions.kSizedBoxH10,

                                  CustomTextFormField(
                                      keyBoardType: TextInputType.number,
                                      onChange: (a){
                                        walletController.amountTransferController.text=a;
                                        if(a.isNotEmpty){
                                          walletController.isAmountTextEmpty.value=false;
                                        }
                                        else{
                                          walletController.isAmountTextEmpty.value=true;
                                        }

                                      },
                                      textColor: Theme.of(context).disabledColor,
                                      controller: walletController.amountTransferController,
                                      fillColor: Colors.transparent,
                                      radius: Dimensions.radiusDefault,
                                      hintText: '', isValidate: false),
                                  ...
                                  Obx(()=>
                                      CustomTTButton(
                                        ...
                                        isRounded: true,
                                        bgColor:walletController.isAmountTextEmpty.value? Theme.of(context).unselectedWidgetColor:
                                        Theme.of(context).primaryColor,
                                        text: 'Continue'.tr,
                                        onTap: () {
                                          if(walletController.amountTransferController.text.isNotEmpty&& walletController.receivePhoneController.text.isNotEmpty){
                                            Get.to(()=>WalletTransferConfirm(amount: walletController.amountTransferController.text,phone: walletController.receivePhoneController.text,));
                                          }
