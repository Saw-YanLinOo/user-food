...
import 'package:user/data/model/response/review_model.dart';
...
import 'package:user/view/screens/chat/widget/image_dialog.dart';
import 'package:user/view/screens/order/widget/cancellation_dialogue.dart';
import 'package:user/view/screens/order/widget/delivery_details.dart';
import 'package:user/view/screens/order/widget/log_dialog.dart';
import 'package:user/view/screens/order/widget/order_product_widget.dart';
import 'package:user/view/screens/order/widget/subscription_pause_dialog.dart';
import 'package:user/view/screens/restaurant/widget/review_dialog.dart';
import 'package:user/view/screens/review/rate_review_screen.dart';
...
class OrderDetailsScreenState extends State<OrderDetailsScreen>
  ...
  void _loadData() async {
    await Get.find<OrderController>().trackOrderForGuest(
    ...
    return WillPopScope(
      ...
      child: GetBuilder<OrderController>(builder: (orderController) {
        ...
        if (orderController.orderDetails != null && order != null) {
          ...
          takeAway = order.orderType != 'delivery';
          ...
          appServiceFee = order.totalAppServiceFee;
          ...
          pastOrder = (order.orderStatus == 'delivered' ||
              order.orderStatus == 'failed' ||
              order.orderStatus == 'refund_requested' ||
              order.orderStatus == 'refunded' ||
              order.orderStatus == 'refund_request_canceled' ||
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                            ...
                                            children: [
                                              ...
                                              Row(children: [
                                                Text(
                                                    '${subscription ? 'subscription_id'.tr : 'order_id'.tr}:',
                                                    style: robotoRegular),
                                                const SizedBox(
                                                    width: Dimensions
                                                        .paddingSizeExtraSmall),
                                              ...
                                              ? Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                        ...
                                                        style: robotoRegular),
                                                    Text(
                                                        '(+) ${PriceConverter.convertPrice(appServiceFee)}',
                                                        style: robotoRegular,
                                                        textDirection:
                                                            TextDirection.ltr),
                                                  ],
                                            ...
                                            onPressed: () {
                                              Get.dialog(ConfirmationDialog(
                                                  ...
                                                  onYesPressed: () {
                                                    ...
                                                    if (maxCodOrderAmount >
                                                        total) {
                                                      orderController
                                                          .switchToCOD(order.id
                                                              .toString())
                                                          .then((isSuccess) {
                                                        Get.back();
                                                        if (isSuccess) {
