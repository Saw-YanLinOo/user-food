...
class RestaurantDescriptionView extends StatelessWidget {
  ...
  const RestaurantDescriptionView({super.key, required this.restaurant});
      ...
      Row(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(children: [
                Icon(Icons.delivery_dining, color: Theme.of(context).indicatorColor, size: 20),
                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                Text(
                  '${'delivery_fee'.tr} - ${restaurant!.maximumShippingCharge} ${'currency'.tr}', textDirection: TextDirection.ltr,
        ...
        Container(
          ...
          child: Row(children: [
            Icon(Icons.watch_later_outlined, color: Theme.of(context).indicatorColor, size: 20),
            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
            Text(
