...
import 'package:user/view/screens/chat/widget/message_bubble.dart';
...
class ChatScreen extends StatefulWidget {
  ...
  final int? index;
  const ChatScreen({super.key, required this.notificationBody, required this.user, this.conversationID, this.index});
