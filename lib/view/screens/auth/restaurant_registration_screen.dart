...
import 'package:user/data/model/body/translation.dart';
...
import 'package:user/view/screens/auth/widget/custom_time_picker.dart';
import 'package:user/view/screens/auth/widget/pass_view.dart';
import 'package:user/view/screens/auth/widget/select_location_view.dart';
...
class _RestaurantRegistrationScreenState extends State<RestaurantRegistrationScreen> {
        ...
        return WillPopScope(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              centerTitle: true,
              title: CustomText(text:'restaurant_registration'.tr, color: Theme.of(context).disabledColor, fontWeight: FontWeight.bold,fontSize: 14.sp,),
            ),
            body: SafeArea(
              child: Center(
                        ...
                        Expanded(
                            child: SingleChildScrollView(
                              ...
                              child: SizedBox(
                                ...
                                child: ResponsiveHelper.isDesktop(context) ? webView(authController) :
                                Column(children: [
                                              ...
                                              Padding(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: authController.pickedLogo != null ? GetPlatform.isWeb ? Image.network(
                                                    authController.pickedLogo!.path, width: MediaQuery.of(context).size.width/2, height: 120, fit: BoxFit.cover,
                                                  ) : Image.file(
                                                    File(authController.pickedLogo!.path), width: MediaQuery.of(context).size.width/2, height: 120, fit: BoxFit.cover,
                                                  ) : SizedBox(
                                                   width: MediaQuery.of(context).size.width/2, height: 120,
                                                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [

                                                      Icon(Icons.photo, size: 50.w, color: Theme.of(context).disabledColor),
                                                      const SizedBox(height: Dimensions.paddingSizeSmall),
                                              ...
                                              Padding(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: authController.pickedCover != null ? GetPlatform.isWeb ? Image.network(
                                                    authController.pickedCover!.path, width: MediaQuery.of(context).size.width/2, height: 120, fit: BoxFit.cover,
                                                  ) : Image.file(
                                                    File(authController.pickedCover!.path), width: MediaQuery.of(context).size.width/2, height: 120, fit: BoxFit.cover,
                                                  ) : SizedBox(
                                                    width: MediaQuery.of(context).size.width/2, height: 120,
                                                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Theme.of(context).cardColor,
                          borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                          //border: Border.all(color: Theme.of(context).secondaryHeaderColor, width: 0.5),
                        ),
                        padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
                        child: Row(children: [
                          Expanded(child: Text(
  ...
  Widget buttonView(){
    return GetBuilder<AuthController>(builder: (authController){
      return CustomButton(
        isLoading: authController.isLoading,radius: Dimensions.roundRadius,
        margin: EdgeInsets.all((ResponsiveHelper.isDesktop(context) || ResponsiveHelper.isWeb()) ? 0 : Dimensions.paddingSizeSmall),
        buttonText: authController.storeStatus == 0.4 && !ResponsiveHelper.isDesktop(context) ? 'Continue'.tr : 'submit'.tr,
        onPressed: () {
