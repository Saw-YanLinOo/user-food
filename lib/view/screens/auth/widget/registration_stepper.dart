...
class RegistrationStepper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Color color = onGoing ? Theme.of(context).secondaryHeaderColor : isActive ? Theme.of(context).secondaryHeaderColor : Theme.of(context).disabledColor;
    Color right = onGoing ? Theme.of(context).disabledColor : rightActive ? Theme.of(context).secondaryHeaderColor : Theme.of(context).disabledColor;
    return Expanded(
        ...
        Row(children: [
          ...
          SizedBox(
            ...
            child: Text(
              ...
              style: robotoMedium.copyWith(color: Theme.of(context).secondaryHeaderColor, fontSize: Dimensions.fontSizeExtraSmall),
            ),
          ),
      ]),
    );
