  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: CustomText(text:'delivery_man_registration'.tr, color: Theme.of(context).disabledColor, fontWeight: FontWeight.bold,fontSize: 14.sp,),
      ),
      body: SafeArea(
                        ...
                        (authController.vehicleIds != null &&
                            ...
                            ? Container(
                                ...
                                child: CustomDropdown<int>(
                                  ...
                                  items: vehicleList,
                                  child: Text(authController
                                      .vehicles![authController.vehicleIndex!]
                                      .type!
                                      .tr),
                                ),
                              )
                          ...
                          child: CustomDropdown<int>(
                            onChange: (int? value, int index) {
                              authController.setIdentityTypeIndex(
                                  authController.identityTypeList[index], true);
                            },
                            dropdownButtonStyle: DropdownButtonStyle(
                              height: 45,
                              padding: const EdgeInsets.symmetric(
  ...
  Widget buttonView() {
    return GetBuilder<AuthController>(builder: (authController) {
      return CustomButton(
        ...
        buttonText: authController.dmStatus == 0.4 ? 'Continue'.tr : 'submit'.tr,
