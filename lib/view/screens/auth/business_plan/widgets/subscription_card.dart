...
class SubscriptionCard extends StatelessWidget {
  ...
  final Color color;
  const SubscriptionCard({super.key, required this.index, required this.package, required this.authController, required this.color});
    ...
    return Container(
      ...
      child: Column(
        ...
        Padding(
          ...
          child: Text(
            '${package.packageName}',
            style: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).disabledColor),
          ...
          child: Row(
            ...
            children: [
              Text(
                ...
                style: robotoBold.copyWith(fontSize: 25.sp, ),
              ),
