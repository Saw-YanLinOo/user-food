...
import 'package:user/view/screens/checkout/widget/payment_failed_dialog.dart';
...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  PullToRefreshController? pToRefreshController;
  ...
  void _initData() async {
    ...
    pToRefreshController = PullToRefreshController(
   ...
   // browser.pullToRefreshController =pToRefreshController ;
...
class MyInAppBrowser extends InAppBrowser {
  ...
  MyInAppBrowser({required this.orderID, required this.orderAmount, required this.maxCodOrderAmount, super.windowId, super.initialUserScripts});
