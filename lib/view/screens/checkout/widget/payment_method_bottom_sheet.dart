...
import 'package:user/view/screens/checkout/widget/payment_button_new.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: GetBuilder<OrderController>(builder: (orderController) {
            return Column(children: [
              ...
              SizedBox(
                  height:
                      isDigitalPaymentActive ? Dimensions.paddingSizeSmall : 0),
              isWalletActive
                  ? PaymentButtonNew(
                      icon: Images.wallet,
                  ...
                  : const SizedBox(),
              SizedBox(
                  height: isWalletActive ? Dimensions.paddingSizeSmall : 0),
              isOnlineActive
                  ? PaymentButtonNew(
