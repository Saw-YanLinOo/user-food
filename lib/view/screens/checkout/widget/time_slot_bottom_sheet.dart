...
import 'package:user/view/screens/checkout/widget/slot_widget.dart';
...
class TimeSlotBottomSheet extends StatelessWidget {
  ...
  const TimeSlotBottomSheet({super.key, required this.tomorrowClosed, required this.todayClosed});
