...
class _OrderSuccessfulScreenState extends State<OrderSuccessfulScreen> {
  ...
  void initState() {
    super.initState();
    AuthHelper.isGuestLoggedIn()? Get.find<OrderController>().trackOrder(widget.orderID.toString(), null, false):
   Get.find<OrderController>().trackOrderForGuest(widget.orderID.toString(), null, false);
  }
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        if (orderController.trackModel != null) {
          ...
          success = orderController.trackModel!.paymentStatus == 'paid' ||
              ...
              orderController.trackModel!.paymentMethod == 'kpay';
