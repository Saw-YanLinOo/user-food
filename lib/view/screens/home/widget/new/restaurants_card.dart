...
import 'package:user/view/base/handover/not_available_delivery.dart';
...
import 'package:user/view/screens/home/widget/new/overflow_container.dart';
...
class RestaurantsCard extends StatelessWidget {
  ...
  final bool? isNewOnMOMOFood;
  const RestaurantsCard(
      {super.key, this.isNewOnMOMOFood, required this.restaurant});

  @override
  Widget build(BuildContext context) {
    bool isAvailable = restaurant.open == 1 && restaurant.active!;
    bool isHomeDelivery = restaurant.delivery == true;
                ...
                Stack(
                  children: [
                    Container(
                      ...
                      height: isNewOnMOMOFood! ? 98 : 68,
                      width: isNewOnMOMOFood! ? 98 : 78,
                      decoration: BoxDecoration(
                        color: Theme.of(context).cardColor,
                        borderRadius:
                    ...
                    isHomeDelivery
                        ? const SizedBox()
                        : const NotAvailableDelivery(isHomeDelivery: true),
                  ],
                ),
...
class RestaurantsCardShimmer extends StatelessWidget {
  final bool? isNewOnMOMOFood;
  const RestaurantsCardShimmer({super.key, this.isNewOnMOMOFood});

  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: isNewOnMOMOFood!
          ? 300
          : ResponsiveHelper.isDesktop(context)
              ? 160
              : 130,
      child: isNewOnMOMOFood!
          ? GridView.builder(
