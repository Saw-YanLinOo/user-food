          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Color(0xFFEDE2BE), // #EDE2BE
                  Color(0xFFC2A070), // #C2A070
                ],
              ),
            ),
            child:
                    ...
                    : CustomScrollView(
                      ...
                      slivers: [
                        ...
                        SliverAppBar(
                          ...
                          backgroundColor: ResponsiveHelper.isDesktop(context) ? Colors.transparent : Color(0xFFEDE2BE),
                              ...
                              builder: (context, scrollingRate) {
                                ...
                                return Center(
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        // Padding(padding: const EdgeInsets.all(10.0), child: Image.asset(Images.splashLogo, width: 40)),
                                        Expanded(
                                          child: InkWell(
                                            onTap: () {
                                                  ...
                                                  return Row(
                                                    children: [
                                                      Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          color: Color(0xFF3C3A3A).withValues(alpha: 0.2),
                                            ...
                                            builder: (notificationController) {
                                              return Container(
                                                ...
                                                padding: EdgeInsets.all(
                                                  Dimensions.paddingSizeExtraSmall - (scrollPoint * Dimensions.paddingSizeExtraSmall),
                                                ),
                                                child: Stack(
                                                  children: [
                                                    // Icon(
                                                    ...
                                                    Image.asset(
                                                      ...
                                                      width: 18 - (scrollPoint * 18),
                                                      height: 18 - (scrollPoint * 18),
                                                      // color: Theme.of(context).primaryColor,
                                                    ),
                                                    notificationController.hasNotification
                                                        ? Positioned(
                                                          ...
                                                          right: 0,
                                                          child: Container(
                                                            height: 10 - (scrollPoint * 10),
                                                            width: 10 - (scrollPoint * 10),
                                                            decoration: BoxDecoration(
                                                              color: Theme.of(context).primaryColor,
                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _configModel.newRestaurant == 1 ? const NewOnMOMOFoodView(isLatest: true) : const SizedBox(),
                        ...
                        SliverPersistentHeader(pinned: true, delegate: SliverDelegate(height: 85, child: const RestaurantFilterScreen())),

                        const SliverToBoxAdapter(child: Center(child: AllRestaurantScreen())),

                        SliverToBoxAdapter(child: Center(child: ProductFooterView(child: AllProducts(scrollController: _scrollController)))),
                      ],
                    ),
          ),
        ),
