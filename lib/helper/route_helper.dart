...
import 'package:user/view/base/image_viewer_screen.dart';
import 'package:user/view/base/not_found.dart';
import 'package:user/view/screens/address/add_address_screen.dart';
import 'package:user/view/screens/address/address_screen.dart';
import 'package:user/view/screens/auth/business_plan/business_plan.dart';
import 'package:user/view/screens/auth/delivery_man_registration_screen.dart';
import 'package:user/view/screens/auth/restaurant_registration_screen.dart';
...
import 'package:user/view/screens/category/category_product_screen.dart';
import 'package:user/view/screens/category/category_screen.dart';
import 'package:user/view/screens/chat/chat_screen.dart';
import 'package:user/view/screens/chat/conversation_screen.dart';
import 'package:user/view/screens/checkout/checkout_screen.dart';
import 'package:user/view/screens/checkout/order_successful_screen.dart';
import 'package:user/view/screens/checkout/payment_screen.dart';
import 'package:user/view/screens/checkout/payment_webview_screen.dart';
import 'package:user/view/screens/contact_us/contact_us_screen.dart';
import 'package:user/view/screens/coupon/coupon_screen.dart';
import 'package:user/view/screens/cuisine/cuisine_restaurant_screen.dart';
import 'package:user/view/screens/cuisine/cuisine_screen.dart';
import 'package:user/view/screens/dashboard/dashboard_screen.dart';
import 'package:user/view/screens/food/item_campaign_screen.dart';
import 'package:user/view/screens/food/popular_food_screen.dart';
import 'package:user/view/screens/forget/forget_pass_screen.dart';
import 'package:user/view/screens/forget/new_pass_screen.dart';
import 'package:user/view/screens/forget/verification_screen.dart';
import 'package:user/view/screens/home/map_view_screen.dart';
import 'package:user/view/screens/html/html_viewer_screen.dart';
import 'package:user/view/screens/interest/interest_screen.dart';
import 'package:user/view/screens/language/language_screen.dart';
import 'package:user/view/screens/location/access_location_screen.dart';
import 'package:user/view/screens/location/map_screen.dart';
import 'package:user/view/screens/location/pick_map_screen.dart';
import 'package:user/view/screens/notification/notification_screen.dart';
import 'package:user/view/screens/onboard/onboarding_screen.dart';
import 'package:user/view/screens/order/order_details_screen.dart';
import 'package:user/view/screens/order/order_screen.dart';
import 'package:user/view/screens/order/order_tracking_screen.dart';
import 'package:user/view/screens/order/refund_request_screen.dart';
import 'package:user/view/screens/profile/personal_information_screen.dart';
import 'package:user/view/screens/profile/profile_screen.dart';
import 'package:user/view/screens/profile/update_profile_screen.dart';
import 'package:user/view/screens/refer_and_earn/refer_and_earn_screen.dart';
import 'package:user/view/screens/restaurant/all_restaurant_screen.dart';
import 'package:user/view/screens/restaurant/campaign_screen.dart';
import 'package:user/view/screens/restaurant/restaurant_product_search_screen.dart';
import 'package:user/view/screens/restaurant/restaurant_screen.dart';
import 'package:user/view/screens/restaurant/review_screen.dart';
import 'package:user/view/screens/search/search_screen.dart';
import 'package:user/view/screens/support/support_screen.dart';
import 'package:user/view/screens/update/update_screen.dart';
import 'package:user/view/screens/wallet/wallet_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '../view/screens/splash/splash_first_screen.dart';
...
class RouteHelper {
  ...
  static const String additionalInput = '/additional-input';
  static const String additioanlInputCurrent = '/additional-input-current';
  ...
  static String getCheckoutRoute(String page, [String? tableId]) =>
      '$checkout?page=$page&tableId=${tableId ?? "0"}';
  ...
  static String getAdditionalInput() => additionalInput;
  static String getCurrentAdditionalInput() => additioanlInputCurrent;
  ...
  static String getBusinessPlanRoute(int? restaurantId,String? phone) =>
      '$businessPlan?id=$restaurantId&phone=$phone';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          return SplashScreen1(notificationBody: data, linkBody: linkData);
        }),
    GetPage(
        name: language,
        page: () =>
    ...
    //     }),
    // GetPage(
    //     name: additioanlInputCurrent,
    //     page: () {
    //       return AdditioanlCurrentUserInput(
    //         fromSignUp: Get.parameters['page'] == signUp,
    //         route: Get.parameters['page'],
    ...
    GetPage(
        name: restaurant,
        page: () {
          log("arg -> ${Get.arguments.toString()}");
          log("arg -> ${Get.parameters}");
          return getRoute(Get.arguments ??
              RestaurantScreen(
                restaurant: Restaurant(
                  id: int.parse(Get.parameters['id']!),
                ),
                tableId: Get.parameters['tableId'],
              ));
        }),
    GetPage(
        name: orderDetails,
    ...
    GetPage(name: profile, page: () => getRoute( PersonalInformationScreen())),
    GetPage(name: contactUS, page: () => getRoute(const ContactUsScreen())),
    GetPage(
          ...
          return getRoute(checkoutScreen ??
              (!fromCart
                  ...
                  : CheckoutScreen(
                      ...
                      tableId: Get.parameters['tableId'] ?? "0",
                    )));
        }),
    GetPage(
        name: orderTracking,
    ...
    GetPage(
        name: businessPlan,
        page: () =>
            BusinessPlanScreen(restaurantId: int.parse(Get.parameters['id']!),phone: Get.parameters['phone']!,)),
