...
import 'package:user/data/model/response/cuisine_model.dart';
import 'package:user/data/model/response/fund_bonus_body.dart';
...
class Restaurant {
  ...
  Restaurant.fromJson(Map<String, dynamic> json) {
    ...
    zoneId = intConverter(json['zone_id']);
    minimumOrder =
    ...
    appServiceFee = json['app_service_fee']?.toDouble();
    ratingCount = intConverter(json['rating_count ']);
    selfDeliverySystem = intConverter(json['self_delivery_system']);
    posSystem = json['pos_system'];
    open = intConverter(json['open']);
    active = json['active'];
    deliveryTime = json['delivery_time'];
    veg = intConverter(json['veg']);
    nonVeg = intConverter(json['non_veg']);
    categoryIds =
    ...
    minimumShippingCharge = json['minimum_shipping_charge'] != null
        ? doubleConverter(json['minimum_shipping_charge'])
        : 0.0;
    ...
    vendorId = intConverter(json['vendor_id']);
    restaurantModel = json['restaurant_model'];
    restaurantStatus = intConverter(json['restaurant_status']);
    ...
    slug = json['slug'];
    foodsCount = intConverter(json['foods_count']);
    if (json['foods'] != null) {
      foods = <Foods>[];
...
class Foods {
  ...
  Foods.fromJson(Map<String, dynamic> json) {
    ...
    appServiceFee = doubleConverter(json['app_service_fee']);
    taxType = json['tax_type'];
    appServiceFeeType = json['app_service_fee_type'];
    ...
    createdAt = json['created_at'];
    updatedAt = json['updated_at'];
    orderCount = intConverter(json['order_count']);
  ...
  Map<String, dynamic> toJson() {
    ...
    data['app_service_fee'] = appServiceFee;
    data['app_service_fee_type'] = appServiceFeeType;
    data['discount'] = discount;
    data['discount_type'] = discountType;
