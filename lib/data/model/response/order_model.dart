...
import 'package:user/data/model/response/subscription_model.dart';
...
class OrderModel {
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    totalAppServiceFee = json['total_service_fees'].toDouble();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['total_service_fees'] = totalAppServiceFee;
