class ConfigModel {
  ...
  ConfigModel({
    ...
    this.additionCharge,
    this.bannerData,
    this.popupBannerImage,
    this.popupBannerLink,
    this.transferPhoneno,
    this.transferKpay
  });
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    transferPhoneno=json['transfer_phno'];
    transferKpay=json['transfer_kpay'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['transfer_phno']=transferPhoneno;
    data['transfer_kpay']=transferKpay;
    return data;
  }
}
