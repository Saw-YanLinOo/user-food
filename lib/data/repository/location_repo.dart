...
class LocationRepo {
 ...
 Future<Response> addAdditional(String? name, String? note) async {
    return await apiClient.postData(AppConstants.additionalNote,
        {"additional_name": name, "additional_note": note});
  }
