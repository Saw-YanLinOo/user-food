...
class CategoryRepo {
  ...
  Future<Response> getCategoryProductList(String? categoryID, int offset, String type) async {
    return await apiClient.getData('${AppConstants.categoryProductUri}$categoryID?limit=100&offset=$offset&type=$type');
  }

  Future<Response> getCategoryRestaurantList(String? categoryID, int offset, String type) async {
    return await apiClient.getData('${AppConstants.categoryRestaurantUri}$categoryID?limit=100&offset=$offset&type=$type');
  }
