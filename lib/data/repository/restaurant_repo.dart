...
class RestaurantRepo {
  ...
  Future<Response> getRestaurantList(
    ...
    return await apiClient.getData(
        '${AppConstants.restaurantUri}/$filterBy?offset=$offset&limit=30&top_rated=$topRated&discount=$discount&veg=$veg&non_veg=$nonVeg&home_restaurant=$homeRes&big_restaurant=$bigRes&street_shop=$streeShop&online_only_shop=$onlineOnlyShop');
  }
  //&home_restaurant=$homeRes&big_restaurant=$bigRes&street_shop=$StreeShop
  ...
  Future<Response> getRestaurantProductList(
    ...
    return await apiClient.getData(
      '${AppConstants.restaurantProductUri}?restaurant_id=$restaurantID&category_id=$categoryID&offset=$offset&limit=100&type=$type',
    );
  }
